...
# offset. Please change the values from above to experiment
dilation = 1 # make the shape larger
erosion = 0 # make the shape smaller
SDF = np.maximum(SDF1, -SDF2) - dilation + erosion
